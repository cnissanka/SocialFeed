 ...
 */
public class handleAcceptGroupRequest extends AsyncTask<String,Void,String>{
    private Context context;

    public handleAcceptGroupRequest (Context ctx){
        context = ctx;
    }

    @Override
    protected String doInBackground(String... params) {
        String register_url = "http://192.168.43.59:8080/SocialFeed/handleAcceptGroupRequest";
        try {
    ...
    protected void onPostExecute(String s) {
        if (s.equals("success")){
            ...
            alertDialog.setMessage("You added a member!");

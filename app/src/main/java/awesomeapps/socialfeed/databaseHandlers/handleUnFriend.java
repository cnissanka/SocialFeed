 ...
 */
public class handleUnFriend extends AsyncTask<String,Void,String>{
    private Context context;

    public handleUnFriend (Context ctx){
        this.context = ctx;
    }

    @Override
    protected String doInBackground(String... params) {
        String register_url = "http://192.168.43.59:8080/SocialFeed/handleUnFriend";
        try {
            ...
            URLEncoder.encode("friend", "UTF-8") + "=" + URLEncoder.encode(params[0], "UTF-8");
    ...
    protected void onPostExecute(String s) {
        if (s.equals("success")){
            ...
            alertDialog.setMessage("Unfriended your friend!");
            alertDialog.setTitle("Unfriend Message");
        }
    }

 ...
 */
public class handleRejectFriendRequest extends AsyncTask<String,Void,String>{
    private Context context;

    public handleRejectFriendRequest(Context ctx){
        this.context = ctx;
    }

    @Override
    protected String doInBackground(String... params) {
        String register_url = "http://192.168.43.59:8080/SocialFeed/handleRejectFriendRequest";
        try {
            ...
            Log.i("dataset",dataset.getCount() + "");
    ...
    protected void onPostExecute(String s) {
        if (s.equals("success")){
            ...
            alert.setMessage("Successfully Rejected Request!");
            alert.show();
        }
    }

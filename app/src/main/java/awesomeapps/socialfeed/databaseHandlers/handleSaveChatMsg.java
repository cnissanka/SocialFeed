 ...
 */
public class handleSaveChatMsg extends AsyncTask<String,Void,String>{
    private Context context;

    public handleSaveChatMsg (Context ctx){
        this.context = ctx;
    }

    @Override
    protected String doInBackground(String... params) {
        String register_url = "http://192.168.43.59:8080/SocialFeed/handleSaveChatMsg";
        try {
            ...
            post_data = URLEncoder.encode("friend", "UTF-8") + "=" + URLEncoder.encode(friendUsername,"UTF-8") + "&" +
                    ...
                    URLEncoder.encode("content","UTF-8") + "=" + URLEncoder.encode(params[1], "UTF-8");
    ...
    protected void onPostExecute(String s) {
        handleGetChats backgroundWorker3 = new handleGetChats(context);
        backgroundWorker3.execute(ChatApp.friendname);
    }

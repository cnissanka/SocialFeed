 ...
 */
public class handleGetFriendDetails extends AsyncTask<String, Void, String>{
    private Context context;

    public handleGetFriendDetails(Context ctx) {
        this.context = ctx;
    }
    ...
    protected void onPostExecute(String s) {
        ...
        FriendDetails.friendName.setText(dataset[1]);
        FriendDetails.friendDob.setText(dataset[2]);
        FriendDetails.friendGender.setText(dataset[3]);
        FriendDetails.friendStatus.setText(dataset[4]);
    }

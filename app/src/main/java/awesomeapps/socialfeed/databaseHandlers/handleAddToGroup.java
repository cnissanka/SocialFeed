 ...
 */
public class handleAddToGroup extends AsyncTask<String,Void,String>{
    private Context context;

    public handleAddToGroup (Context ctx){
        this.context = ctx;
    }

    @Override
    protected String doInBackground(String... params) {
        String register_url = "http://192.168.43.59:8080/SocialFeed/handleAddToGroup";
        try {
            ...
            post_data = URLEncoder.encode("group", "UTF-8") + "=" + URLEncoder.encode(groupName,"UTF-8") + "&" +
